...
<? foreach( $projects as $proj){?>
   ...
   <?if($proj['project_name'] == "Greenhouse"){?>
         <a class="link-image-project"  href="flyport_project?project_name=<?= $proj['project_name']?>"><img src="/images/serra.png"><span class="project-name"><?= $proj['project_name']?></span></a><br>
   <?   } ?>
   <?if($proj['project_name'] == "Everpicus"){?>
         <a class="link-image-project" href="flyport_project?project_name=<?= $proj['project_name']?>"><img src="/images/evernote.png"><span class="project-name"><?= $proj['project_name']?></span></a><br>
   <?   } ?>
